...
export default {
  ...
  methods: {
    createUrl(file) {
      if (window.URL) {
        /**
         * window.URL.createObjectURL会根据传入的参数创建一个指向该参数对象的URL
         * 该URL的生命仅存在于它被创建的这个文档中
         */
    ...
    uploadImg() {
      ...
      // console.log(this.imgSrc)    // blob:http://localhost:8080/d4a74e02-fb43-4ea9-be9e-9507ffc97613
    }
  }
}
</script>

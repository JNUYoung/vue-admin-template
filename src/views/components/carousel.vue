...
export default {
  data() {
    return {
      imgSrc: [
        "../../assets/slide_images/slide-0.jpg",
        "../../assets/slide_images/slide-1.jpg",
        "../../assets/slide_images/slide-2.jpg",
        "../../assets/slide_images/slide-3.jpg",
        "../../assets/slide_images/slide-4.jpg",
      ]
    }
  }
}
